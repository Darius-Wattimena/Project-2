...
class Player(GameObject):
    def __init__(self, object_group: GameObjectGroup, py_screen, debug):
        super().__init__(object_group, 1, True, py.Rect([250, 400], [35 * 3, 80 * 3]))
        self.debug = debug
        self.damage_max = 10
        self.damage_min = 3
        self.health = 100
    ...
    def load_player_sprite(self):
        ...
        idle_image = self.load_sprite("resources/graphics/minigame_1/player/idle2.png")
        walk_image = self.load_sprite("resources/graphics/minigame_1/player/walk2.png")
        punch_image = self.load_sprite("resources/graphics/minigame_1/player/punch2.png")
